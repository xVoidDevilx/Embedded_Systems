...
#define HISTORYLEN 5     // History of commands
//LOOP MACROS
#define SUPPORTEDCMDS 14  // Total Commands Being supported by the system right now
...
typedef struct _global
{
    ...
    char oldCmds[HISTORYLEN][MAXLEN];   // Storage unit to track old commands processed from UART0
