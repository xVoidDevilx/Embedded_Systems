...
/* PK5 */
extern const uint_least8_t          CONFIG_GPIO_AMP_ON_CONST;
#define CONFIG_GPIO_AMP_ON          4
/* PD4 */
extern const uint_least8_t          CONFIG_GPIO_MIC_CONST;
#define CONFIG_GPIO_MIC             5
/* PJ0, LaunchPad Button USR_SW1 (Left) */
extern const uint_least8_t          LSW_CONST;
#define LSW                         6
/* PJ1, LaunchPad Button USR_SW2 (Right) */
extern const uint_least8_t          RSW_CONST;
#define RSW                         7
