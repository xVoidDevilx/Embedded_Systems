...
//LOOP MACROS
#define SUPPORTEDCMDS 8  // Total Commands Being supported by the system right now
...
void GlobalConfig(global *glo, UART_Handle uart, Timer_Handle timer0);  // Config the global struct
