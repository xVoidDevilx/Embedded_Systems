...
GPIO_PinConfig gpioPinConfigs[CONFIG_GPIO_COUNT] = {
    ...
    /* LSW : LaunchPad Button USR_SW1 (Left) */
    GPIOMSP432E4_PJ0 | GPIO_CFG_IN_PU | GPIO_CFG_IN_INT_FALLING,
    /* RSW : LaunchPad Button USR_SW2 (Right) */
 ...
 */
extern void LSWCallback(uint_least8_t index);
extern void RSWCallback(uint_least8_t index);
...
const uint_least8_t CONFIG_GPIO_AMP_ON_CONST = CONFIG_GPIO_AMP_ON;
const uint_least8_t CONFIG_GPIO_MIC_CONST = CONFIG_GPIO_MIC;
const uint_least8_t LSW_CONST = LSW;
const uint_least8_t RSW_CONST = RSW;
